...
public class Charizard extends CreateEntity
{
    ...
    public Charizard(String id, Point position, List<PImage> images, int animationPeriod, int actionPeriod) {
            ...
            EventScheduler scheduler)
    {
        Optional<Entity> target =
                findNearest(world, this.getPosition(), new ArrayList<>(Arrays.asList(PokeTree.class)));
